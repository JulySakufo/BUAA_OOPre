...
public class Demon {
    ...
    private final HashMap<Integer, Team> teams;//id与team的map;
    ...
    private void makeSoldier() {
        ...
        unformedSoldiers.put(str1, new Soldier(str1, str2));//只生成了士兵，但是并未编队；以name存储;
    } //correct;
    ...
    private void formSoldier() {
        ...
        for (int i = 0; i < num; i++) {
            ...
            unformedSoldiers.remove(name);//从未被编队的士兵的编号中删去这个编队的士兵;
        }
        teams.put(id, team);//形成一个编号为id的队;
    } //correct;
    ...
    private void mergeId2Id() {
        ...
        team2.clear_soldiers();//id2小队不复存在,让它指向一片空即可;
    } //correct
